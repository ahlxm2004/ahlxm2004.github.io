...
<meta charset = "utf-8">
<script type = "text/javascript" src = "../../additional_files/JS/jquery.min.js"></script>
<link type = "text/css" rel = "stylesheet" href = "2048.css"></link>
...
<div id = "game-wrapper">
	<div id = "header">
		<div class = "score" id = "current-score"></div>
		<div class = "score" id = "best-score"></div>
		<button type = "button" class = "button" id = "button" onClick = "restart()">restart</button>
	</div>
